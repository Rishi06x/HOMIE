              ...
              >
                ...
                {step === 2 && isProvider && (
                  <>
                    ...
                    <p className="text-slate-500 text-sm mb-4">No formal degrees or certificates required! Just upload a government-issued ID (like Aadhaar, Voter ID, or DL) to prove your identity and build trust with customers.</p>
                    ...
                    <div className="border-2 border-dashed border-slate-200 dark:border-slate-700 rounded-2xl p-10 flex flex-col items-center justify-center text-center cursor-pointer hover:bg-slate-50 dark:hover:bg-slate-800/50 transition-colors">
                      ...
                      <h4 className="font-semibold text-slate-900 dark:text-white mb-1">Click to upload your ID</h4>
                      <p className="text-sm text-slate-500">Aadhaar / PAN / DL (Image or PDF, max 5MB)</p>
                    </div>
                  </>
                )}
